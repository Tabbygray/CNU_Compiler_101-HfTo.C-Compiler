...
작성에 사용된 언어 : Java JVM 11 ( intelliJ IDE )
사용된 컴파일러 : javac 14.0.1

>> 프로그램 사용 방법 <<
 프로그램이 위치한 곳과 같은 디렉터리에 변환할 .hf 파일을 배치합니다.
프로그램 이름 : "HfTo.C-Compiler.jar"
※이 때, 변환할 파일의 이름은 반드시 "Sample.hf" 이어야 합니다!
